...
public class InheritanceChallenge {
    ...
    public InheritanceChallenge(String name, int age) {
        this.name = name;
        this.age = age;
    }
    ...
    public static void main(String[] args) {
        ...
        InheritanceChallenge animal = new InheritanceChallenge("Mammals", 100);
        InheritanceChallenge dog = new Dog("Rocky",95);
        InheritanceChallenge cat = new Cat("Chimli",89);
        animal.makeSound();;
        dog.makeSound();
        cat.makeSound();
